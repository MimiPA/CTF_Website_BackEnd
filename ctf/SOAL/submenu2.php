...
<?php  include "template/header.temp.php"; ?>
	...
	<div class="menuContainer">
		<?php
			...
			$id = '7';
			$judulSoal	='f14g5';
			$hint		='<a href="https://ctfwebsitefreehosting.000webhostapp.com/f14g5.png">This Is Flag</a>			';
			include 'template/boxsoal.temp.php';
				  
			$id = '8';
			$judulSoal	='Tom';
			$hint		='<a href="https://ctfwebsitefreehosting.000webhostapp.com/tom.png
			">This Is Tom</a>';
			include 'template/boxsoal.temp.php';

			$id = '9';
			$judulSoal	='k3l1l1n9 dun14';
			$hint		='<a href="https://ctfwebsitefreehosting.000webhostapp.com/k3l1l1n9%20dun14a.txt
			">TXT</a>';
			include 'template/boxsoal.temp.php';
